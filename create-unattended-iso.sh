...
read -ep " please enter your preferred username: " hostname
currentuser="$( whoami)"
...
if [[ $ub1604 == "yes" ]]; then
   ...
   # Update apt repo, install wget and gnome desktop
   late_command="apt-get update; apt install wget -y; apt install ubuntu-gnome-desktop -y;"
fi
# else 
